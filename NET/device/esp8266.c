...
#define WIFI_SSID 						"xiaomi"					//	WIFI的名称 必须用2.4G的wifi不能用5G的，且不能用中文、空格
#define WIFI_PSWD 						"123456789"				//	WIFI密码

#define SERVER_HOST						"120.79.100.106"			//	MQTT服务器域名或IP
...
void ESP8266_Init(void)
{
	...
	GPIO_Initure.GPIO_Pin = GPIO_Pin_5;					//GPIOC14-复位
