...
#define	LCD_SDA_SET  	GPIOB->BSRRL = GPIO_Pin_15  //GPIO_SetBits(GPIOB,GPIO_Pin_15)
#define	LCD_SCL_SET  	GPIOB->BSRRL = GPIO_Pin_13  //GPIO_SetBits(GPIOB,GPIO_Pin_13) 

#define	LCD_CS_SET  	GPIOB->BSRRL = GPIO_Pin_12  //GPIO_SetBits(GPIOB,GPIO_Pin_12)   
#define LCD_RST_SET   GPIOB->BSRRL = GPIO_Pin_14  //GPIO_SetBits(GPIOB,GPIO_Pin_14)

#define	LCD_RS_SET  	GPIOB->BSRRL = GPIO_Pin_2   //GPIO_SetBits(GPIOB,GPIO_Pin_2)   
#define	LCD_BLK_SET  	GPIOB->BSRRL = GPIO_Pin_10   //GPIO_SetBits(GPIOB,GPIO_Pin_10)   

//液晶控制口置0操作语句宏定义

#define	LCD_SDA_CLR  	GPIOB->BSRRH = GPIO_Pin_15  //GPIO_ResetBits(GPIOB,GPIO_Pin_15)    
#define	LCD_SCL_CLR  	GPIOB->BSRRH = GPIO_Pin_13  //GPIO_ResetBits(GPIOB,GPIO_Pin_13)  

#define	LCD_CS_CLR  	GPIOB->BSRRH = GPIO_Pin_12  //GPIO_ResetBits(GPIOB,GPIO_Pin_12)  
#define LCD_RST_CLR   GPIOB->BSRRH = GPIO_Pin_14  //GPIO_ResetBits(GPIOB,GPIO_Pin_14)

#define	LCD_RS_CLR  	GPIOB->BSRRH = GPIO_Pin_2   //GPIO_ResetBits(GPIOB,GPIO_Pin_2) 
#define	LCD_BLK_CLR  	GPIOB->BSRRH = GPIO_Pin_10   //GPIO_ResetBits(GPIOB,GPIO_Pin_10) 


#define	LCD_BLK_On          LCD_BLK_SET   		 //开背光  LCD背光--PB1 	    
#define	LCD_BLK_Off         LCD_BLK_CLR    		 //关背光  LCD背光--PB1 	 
