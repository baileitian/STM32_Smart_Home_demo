...
{	 
  ...
  GPIO_InitStructure.GPIO_Pin = GPIO_Pin_13| GPIO_Pin_14 |GPIO_Pin_15;//PB13, PB14, PB15复用功能输出	
...
void LCD_GPIO_Init(void)
{
	...
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_2 | GPIO_Pin_10 | GPIO_Pin_12 ;          //| GPIO_Pin_14 | GPIO_Pin_13, |GPIO_Pin_15
  GPIO_InitStructure.GPIO_Mode = GPIO_Mode_OUT;                     //普通输出模式
  GPIO_InitStructure.GPIO_OType = GPIO_OType_PP;                    //推挽输出
  GPIO_InitStructure.GPIO_Speed = GPIO_Speed_100MHz;                //100MHz
  GPIO_InitStructure.GPIO_PuPd = GPIO_PuPd_UP;                      //IO上拉
...
{					   
	...
	LCD_Delay_ms(100);      // delay 100 ms 
	LCD_RS_SET;      //液晶屏复位 --硬复位--失能       //PB14作为液晶屏复位控制引脚
	LCD_Delay_ms(200);      // delay 200 ms 
}	
